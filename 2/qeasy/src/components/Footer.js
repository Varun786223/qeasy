    ...
    <footer className="bg-gray-800 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">QEasy</h3>
            <p className="text-gray-400 mb-4">
              Transforming dining experiences with smart QR menu solutions.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/join" className="text-gray-400 hover:text-white">Join Us</Link>
              </li>
              <li>
                <Link to="/demo" className="text-gray-400 hover:text-white">Request Demo</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/join" className="text-gray-400 hover:text-white">Scan QR Code</Link>
              </li>
              <li>
                <Link to="/about" className="text-gray-400 hover:text-white">How It Works</Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between">
          <p className="text-gray-400">© {new Date().getFullYear()} QEasy. All rights reserved.</p>
